        ...
        return (
          ...
          >
            <CardContent sx={{ padding: 2 }}>
              ...
              <Box sx={{
                display: `flex`, justifyContent: `space-between`, alignItems: `flex-start`, marginBottom: 1.5, 
              }}>
                <Box sx={{
                  display: `flex`, alignItems: `center`, gap: 1, 
                }}>
                  <CalendarToday sx={{
                    fontSize: 16, color: `primary.500`, 
                  }} />
              ...
              {/* Time */}
              <Box sx={{
                display: `flex`, alignItems: `center`, gap: 1, marginBottom: 1.5, 
              }}>
                <Schedule sx={{
